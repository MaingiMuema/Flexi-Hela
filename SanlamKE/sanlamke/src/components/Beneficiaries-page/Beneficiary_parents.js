        ...
        <div class="container   fadeInUp">
            <div class="row beneficiaries-row">
                <div class="col">
                        ...
                        <span>You selected<img class="img-fluid" src={process.env.PUBLIC_URL+"Assets/parentsblue.png"}/></span>
                ...
                <div class="col">
                    <div class="card summary-card" id="b-s-card">
                        <span class="text-center s-ry beneficiary-card-heading"><span class="s-ry">Parent</span><img class="img-fluid summary-img" src={process.env.PUBLIC_URL+"Assets/parents2.png"}/></span>
