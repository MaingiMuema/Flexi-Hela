        ...
        <div class="container   fadeInUp">
            <div class="row beneficiaries-row">
                <div class="col">
                        ...
                        <span>You selected<img class="img-fluid" src={process.env.PUBLIC_URL+"Assets/Partner icon blue.png"}/></span>
                ...
                <div class="col">
                    <div class="card summary-card" id="b-s-card">
                        <span class="text-center s-ry beneficiary-card-heading"><span class="s-ry">Partner</span><img class="img-fluid summary-img" src={process.env.PUBLIC_URL+"Assets/Partner icon grey.png"}/></span>
                       
                        <span class="text-center s-ry" id="set-goals">Relationship: <b>Partner</b></span>
                        ...
                        <hr align="center"class="detail-separator"/>
                        <span class="text-center s-ry" id="set-goals">Phone number: <b> {value}</b></span>
                        <hr align="center"class="detail-separator"/>
...
export default Beneficiary_partner;