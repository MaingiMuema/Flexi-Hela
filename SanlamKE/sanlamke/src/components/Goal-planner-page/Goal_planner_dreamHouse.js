...
const Goal_planner_dreamHouse = () =>{
  ...
  console.log(dataChange);
    ...
    return(
        <div class="container-fluid"  id="c-bg-d-House">
            ...
            <div class="container breadcrumb">
                <p class="d-flex justify-content-start">Get started {'>'} Set Goal  {'>'} Dream house</p>
            </div>
            <div class="container  fadeInUp">
                <div class="row">
                    <div class="col">
                        ...
                        <span>You selected<img class="img-fluid" src={process.env.PUBLIC_URL+"Assets/Dream House2.png"}/></span>
                        <div class="card">
                    ...
                    <div class="col">
                        ...
                        <form action="./action_handler.php">
                            ...
                            <label class="" for="Target-amount2">
                                <input class="input-space-2" type="number" onPaste={(e)=>{e.preventDefault() ; alert("Type it to believe it.");return false }} onInput={dateUpdate} onKeyUp={clearInput} onChange={onChange2} placeholder="Enter Target Goal Amount" id="Target-amount2"/>
                            </label>
                        </form>
                    </div>
                    <div class="col">
                        <div class="card summary-card">
                            <span class="text-center s-ry"><span class="s-ry">Summary</span><img class="img-fluid summary-img" src={process.env.PUBLIC_URL+"Assets/Dream House_grey.png"}/></span>
                            <hr align="center"class="detail-separator"/>
                            <span class="text-center s-ry" id="set-goals">Goal type: <b>Dream House</b></span>
                            <hr align="center"class="detail-separator"/>
                ...
                <div class="card success-card fadeInUp" id="card">
                    ...
                    <div>
                        ...
                        <span class="s-btns">
                            ...
                            <Link to='/Goal_planner_dreamHouse' onClick={handleClick2} class="btn btn-primary" id="s-btn2">NO</Link>
                        </span>
                    </div>
                </div>
            </div>   
...
export default Goal_planner_dreamHouse;