...
const Goal_planner_Other = () =>{
    ...
    function dateUpdate(){
        ...
        var x= inputValue1/inputValue2;
         ...
         document.getElementById('gdate').style.fontSize="12px";
  ...
  console.log(dataChange);
    ...
    return(
        <div class="container-fluid"  id="c-bg-other">
            ...
            <div class="container breadcrumb">
                <p class="d-flex justify-content-start">Get started {'>'} Set Goal  {'>'} Other</p>
            </div>
            <div class="container  fadeInUp">
                <div class="row">
                    <div class="col">
                        ...
                        <span>You selected<img class="img-fluid" src={"Assets/Other2.png"}/></span>
                        <div class="card">
                    ...
                    <div class="col">
                        ...
                        <form action="./action_handler.php">
                            ...
                            <h3>Saving Frequency</h3>
                                <label class="saving-frequency" for="Target-amoun-select">
                    ...
                    <div class="col">
                        <div class="card summary-card">
                            <span class="text-center s-ry"><span class="s-ry">Summary</span><img class="img-fluid summary-img" src={process.env.PUBLIC_URL+"Assets/Other_grey.png"}/></span>
                            <hr align="center"class="detail-separator"/>
                            <span class="text-center s-ry" id="set-goals">Goal type: <b>Other</b></span>
                            <hr align="center"class="detail-separator"/>
                ...
                <div class="card success-card fadeInUp" id="card">
                    ...
                    <div>
                        ...
                        <span class="s-btns">
                            ...
                            <Link to='/Goal_planner_Other' onClick={handleClick2} class="btn btn-primary" id="s-btn2">NO</Link>
                        </span>
                    </div>
                </div>
            </div> 
...
export default Goal_planner_Other;